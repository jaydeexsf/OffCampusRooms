                ...
                <>
                  ...
                  <div className="relative mb-6">
                    <img
                      ...
                      className="w-full h-40 sm:h-48 md:h-56 object-cover rounded-xl border border-gray-600/30"
                    />
                    ...
                    <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/30 rounded-xl p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-300 mt-1">{availabilityStatus}</p>
                        </div>
                        <div className="text-right">
                          <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30 rounded-lg px-3 py-2">
                            <p className="text-green-400 font-semibold text-sm">Available</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  {/* Location & Time */}
                  <div className="mb-6 bg-gradient-to-r from-gray-800/50 to-gray-700/50 border border-gray-600/30 rounded-xl p-4">
                    <div className="flex flex-col sm:flex-row sm:items-center gap-4 text-sm">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-white font-medium">{minutesAway}min to UL</span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                      {Object.keys(amenities).map((amenity) =>
                        amenities[amenity] ? (
                          <div
                            key={amenity}
                            className="flex items-center gap-3 bg-gradient-to-r from-gray-800/50 to-gray-700/50 border border-gray-600/30 px-4 py-3 rounded-xl text-sm"
                          >
                  ...
                  <div className="mb-6">
                    ...
                    <div className="bg-gradient-to-r from-gray-800/50 to-gray-700/50 border border-gray-600/30 rounded-xl p-4 space-y-3">
                      {contact.phone && (
                        <div className="flex items-center gap-3">
                          <div className="p-2 bg-blue-500/20 border border-blue-500/30 rounded-lg">
                      ...
                      {contact.whatsapp && (
                        <div className="flex items-center gap-3">
                          <div className="p-2 bg-green-500/20 border border-green-500/30 rounded-lg">
                            <FiMessageCircle className="text-green-400 w-4 h-4" />
                          </div>
                          <span className="text-white text-sm">{contact.whatsapp}</span>
                        </div>
                      )}
                      {contact.email && (
                        <div className="flex items-center gap-3">
