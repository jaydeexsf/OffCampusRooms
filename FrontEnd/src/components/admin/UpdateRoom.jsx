                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 max-w-2xl mx-auto shadow-2xl">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <label className="text-white font-medium">Room Images (Max 6)</label>
                            <div className="border-2 border-dashed border-white/20 rounded-xl p-6 text-center hover:border-white/40 transition-all duration-200">
                                ...
                                <label htmlFor="image-upload-edit" className="cursor-pointer">
                                    <div className="flex flex-col items-center gap-2">
                                        ...
                                        <span className="text-gray-400">Click to upload new images</span>
                        ...
                        <div className="space-y-2">
                            <label className="flex items-center gap-3 p-4 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-all duration-200 cursor-pointer">
                                <input
                                    type="checkbox"
                                    name="bestRoom"
                                    ...
                                    className="w-4 h-4 text-blue-600 bg-white/10 border-white/20 rounded focus:ring-blue-500 focus:ring-2"
                                />
                                <span className="text-white font-medium">Mark as Best Room</span>
                            </label>
                        </div>
