    ...
    <div className="relative">
      ...
      <div className={`grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 ${isEditRoomOpen ? 'filter blur-md' : ''}`}>
        {displayedRooms.map((room) => (
          <div
            key={room._id}
            className="shadow-lg relative transition-all duration-500 hover:shadow-primary bg-slate-900 rounded-md hover:shadow-xl dark:bg-slate-950 dark:text-white cursor-pointer"
          >
